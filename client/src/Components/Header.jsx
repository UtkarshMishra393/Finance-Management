      ...
      <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        <Link to='/'>
          <h1 className='font-bold text-sm sm:text-xl flex flex-wrap'>
            <span><img src="https://cdn-icons-png.flaticon.com/512/3496/3496311.png" className="h-4 w-4 sm:h-6 md:h-6 md:w-5 my-1 mx-2 rounded-md" alt="logo" /></span>
            <span className='text-yellow-500'>Finance</span>
            <span className='text-yellow-700'>Manager</span>
          </h1>
        </Link>
